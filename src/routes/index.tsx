...
import heroMockup from "@/assets/mockup-novo-hero.webp.asset.json";
...
import mockupRodas from "@/assets/mockup-rodas.webp.asset.json";
import mockupCompleto from "@/assets/mockup-receber.webp.asset.json";
import wheel from "@/assets/capa-front.jpg.asset.json";
import wheel01 from "@/assets/wheels-new/wheel-01.webp.asset.json";
import wheel02 from "@/assets/wheels-new/wheel-02.webp.asset.json";
import wheel03 from "@/assets/wheels-new/wheel-03.webp.asset.json";
import wheel04 from "@/assets/wheels-new/wheel-04.webp.asset.json";
import wheel05 from "@/assets/wheels-new/wheel-05.webp.asset.json";
import wheel06 from "@/assets/wheels-new/wheel-06.webp.asset.json";
import wheel07 from "@/assets/wheels-new/wheel-07.webp.asset.json";
import wheel08 from "@/assets/wheels-new/wheel-08.webp.asset.json";
import wheel09 from "@/assets/wheels-new/wheel-09.webp.asset.json";
import wheel10 from "@/assets/wheels-new/wheel-10.webp.asset.json";
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="relative rounded-2xl border-4 border-neon-dark p-6 flex flex-col shadow-2xl bg-white">
              ...
              <p className="text-center text-purple-deep/70 mt-1 mb-[30px]" style={{ fontSize: "18px", lineHeight: "18px" }}>Para quem quer os 200 mapas + 3 bônus para conduzir sessões com mais segurança.</p>
