...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "+200 Rodas Matemáticas | Material Pronto para Imprimir" },
      ...
      { property: "og:title", content: "+200 Rodas Matemáticas | Material Pronto para Imprimir" },
      { property: "og:description", content: "Transforme cada conteúdo em um mapa visual construído pelos alunos com anotações." },
