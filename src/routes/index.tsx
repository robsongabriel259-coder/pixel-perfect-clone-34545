...
function Landing() {
  useEffect(() => {
    ...
    function trackPixelOnce(key: string, eventName: string, params?: Record<string, string>) {
      if (win.__lpEventsSent?.[key]) return;
      ...
      observer = new IntersectionObserver(function (entries) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            trackPixelOnce("viewcontent_precos", "ViewContent", {
    ...
    function handleCheckoutClick(this: HTMLAnchorElement, event: MouseEvent) {
      ...
      trackPixelOnce("lead_qualificado_checkout", "Lead", {
