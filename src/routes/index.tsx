      ...
      <section className="bg-purple-glow py-14">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="flex justify-center mt-8">
            <img src={mockupRodas.url} alt="Material completo Rodas Matemáticas" loading="lazy" decoding="async" width={680} height={742} className="w-full max-w-[432px] h-auto border-[2px] border-neon rounded-[15px]" />
          </div>
