...
const FB_PIXEL_ID = "1044829704880739";
    ...
    <html lang="pt-BR">
      <head>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: FB_PIXEL_SCRIPT }}
        />
        <script
          type="text/javascript"
          dangerouslySetInnerHTML={{ __html: "window.__fbqEventsSent = window.__fbqEventsSent || {};" }}
        />
      </head>
      <body>
        {children}
